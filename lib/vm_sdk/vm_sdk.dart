...
class VMSDKWidget extends StatefulWidget {
  final Function(VMSDKController controller) onControllerCreated;

  const VMSDKWidget({Key? key, required this.onWebViewControllerCreated, required this.onControllerCreated})
      : super(key: key);

  final Function(InAppWebViewController controller) onWebViewControllerCreated;

  @override
  State<VMSDKWidget> createState() => _VMSDKWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
        ...
        child: Stack(children: [
          ...
          TextBoxBuilder(controller: controller.textBoxConfigController, config: controller.textConfig)
        ]));
  }
}

class VMSDKController {
  VMTextHandler get vmTextHandler => _vmTextHandler;

  TextBoxConfigController get textBoxConfigController => _textBoxConfigController;

  CanvasTextConfig get textConfig => _textConfig;
